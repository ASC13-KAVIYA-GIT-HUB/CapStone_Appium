...
public class Search_Test {
    ...
    public void setup(ITestContext context) {
        try {
            ...
            caps.setCapability("deviceName", "Kaviya's S25 Ultra");
            caps.setCapability("udid", "R5CY53XTXCZ");
    ...
    public void searchProduct() throws Exception {
        try {
            ...
            searchInput.sendKeys("Sephora Lipstick");
            System.out.println("Entered 'Sephora Lipstick'");
